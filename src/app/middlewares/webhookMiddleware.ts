...
import { verifyPlaidWebhook } from '@/app/config/plaid';
import { IWebhookRequest } from '@/app/types/webhook.types';
...
export const validateWebhookSignature = (service: VerifyWebhookOptions['service']) => {
